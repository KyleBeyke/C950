...
class WGUPS:
    ...
    def load_trucks(self):
        """
        Load the packages onto the trucks based on priority and requirements.

        This method optimizes the truck route and sorts the package list. It initializes three trucks and separates the packages into different priority lists based on their requirements and deadlines. The packages are then added to the corresponding trucks based on their requirements.

        Args:
            self: The DeliveryManager object.
    ...
    def load_trucks(self):
        ...
        for package_id in sorted_package_list:
            ...
            # If the package has a deadline and it's not end of day
                ...
                # If the package has accompaniments, add them to the first priority list as well
                if package.package_accompaniment is not None:
                    for package_id in package.package_accompaniment:
                        first_priority_list.append(package_id)
